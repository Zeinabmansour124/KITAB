...
<?php include('../../../includes/components/bar.php'); ?>  <!-- ✅ NAVBAR AJOUTÉE -->
...
<?php if (!$isLoggedIn): ?>
    <div style="text-align:center; padding:4rem 2rem;">
        <span class="material-icons" style="font-size:4rem; color:#c62828;">lock</span>
        <h2 style="color:#c62828; margin:1rem 0;">Accès refusé</h2>
        <p style="color:#555; margin-bottom:1.5rem;">Vous devez être connecté pour publier un livre.</p>
        <a href="../../../pages/login.php" 
           style="background:#2e7d32;color:#fff;padding:0.7rem 2rem;border-radius:8px;text-decoration:none;">
            Se connecter
        </a>
    </div>
    <?php exit; ?>
                ...
                <div class="form-grid">
                    ...
                    <div class="field full">
                        ...
                        <label style="display:flex;align-items:center;gap:8px;cursor:pointer;">
                            <input type="checkbox" name="exchange" value="1"> <!-- ✅ CHECKBOX AJOUTÉE -->
